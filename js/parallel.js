...
var parallel_months = ['Jun', 'Jul', 'Aug', 'Sep']
var parallel_color_set = d3.scale.ordinal().domain(parallel_months).range(['#FFAE96', '#EA9CED', '#EFD44C', '#54BF7E'])
...
function update_colors(dimension) {
	...
	parallel_color_set.domain([d3.min(values), d3.max(values)]);


	// change colors for each line
	graph.color(function(d){return parallel_color_set([d[dimension]])}).render();
};
